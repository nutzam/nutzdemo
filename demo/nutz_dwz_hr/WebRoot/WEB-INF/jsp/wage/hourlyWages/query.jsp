...
<div class="page">
	<div class="pageContent">
		<form method="post" action="HourlyWages/list" class="pageForm" onsubmit="return navTabSearch(this, 'hourlyWages');">
...
<!-- 				</div> -->
		        ...
		        <div>
				<label>日期：</label>
				<input type="text" name="date" value="${obj.o.date}" size="25" />
				<span class="inputInfo">日期</span>
				</div>
		        <div>
				<label>工作时间：</label>
				<input type="text" name="workHour" value="${obj.o.workHour}" size="25" />
				<span class="inputInfo">工作时间</span>
				</div>
		        <div>
				<label>生产单号：</label>
				<input type="text" name="productionOrder" value="${obj.o.productionOrder}" size="25" />
				<span class="inputInfo">生产单号</span>
				</div>
		        <div>
				<label>员工：</label>
		        ...
		        <div>
				<label>工种：</label>
				<input type="text" name="typeOfWork" value="${obj.o.typeOfWork}" size="25" />
...
<%-- 			    <div>
		        ...
		        <div>
				<label>备注：</label>
				<input type="text" name="remarks" value="${obj.o.remarks}" size="25" />
				<span class="inputInfo">备注</span>
				</div>
<!-- 				<div class="divider">divider</div> -->
<!-- 				<div> -->
<!-- 					<label>排序条件：</label> -->
