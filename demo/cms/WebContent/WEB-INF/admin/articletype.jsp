...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="${ctx}/script/articletype.js"></script>
				...
				<div class="content-box">
					...
					<div class="content-box-content">
										...
										<c:otherwise>
											<c:forEach var="type" items="${pm.result}" varStatus="status">
												<tr id="r${type.id}">
													...
													<td>
														<!-- Icons -->
														<a href="javascript:delById('${ctx}',${type.id});" title="删除文章分类信息"><img src="${ctx}/images/icons/cross.png" alt="删除文章分类信息" /></a>
						...
						<div class="tab-content" id="tab2">
							...
							<form method="post">
								<input type="hidden" name="type.id" value="0" id="articletypeid"/>
								<fieldset>
									...
									<p>
										<input class="button" type="button" value="保存" onclick="addType('${ctx}');"/>
									</p>
