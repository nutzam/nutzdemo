      ...
      <div class="newsxx mar2">
          ...
          <div class="dchdbox">
              <dl>
                  <dt>
                      <strong>活动时间</strong>
                      <span><fmt:formatDate value="${article.createDate}" pattern="yyyy"/></span>
                      <b><fmt:formatDate value="${article.createDate}" pattern="MM月dd日"/></b>
                  </dt>
                  <dd>
                      <span>活动介绍</span>
                      <p>${fn:substring(fht:delHTMLTag(article.content),0,130)}...<a href="${ctx}/article/detail?nav=${navsec}&model=${model.id}&article=${article.id}">[活动详细]</a></p>
                  </dd>
              </dl>
          </div>
