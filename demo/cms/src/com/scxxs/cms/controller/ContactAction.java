...
public class ContactAction extends BaseAction{
	...
	public View find(Ioc ioc,HttpServletRequest req){
	...
	@Ok("json")
	public String contact(Ioc ioc,@Param("::con.") Contact con,ServletContext context){
//		ContactDao dao=new ContactDao(ioc);
		Contact c= basicDao.find(1, Contact.class);
		File file=new File(context.getRealPath("/")+"contact/"+c.getImgurl());
		if(file.exists()){
			file.delete();
		}
		boolean flag=false;
...
public void  upload(@Param("..") Map<String,Object> allFields,HttpServletResponse resp,ServletContext context) throws IOException{
