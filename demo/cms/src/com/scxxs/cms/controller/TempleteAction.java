...
public class TempleteAction extends BaseAction{
	...
	@Ok("Json")
	public String save(@Param("::t.") Templete t,Ioc ioc,@Param("type") String type){
	...
	public void uploadTemplate(@Param("template") TempFile tf,
			...
			ServletContext context,HttpServletResponse resp) throws IOException{
...
//		TempleteDao dao = new TempleteDao(ioc);
		...
		if(type!=null&&!"".equals(type)){
			...
			result = basicDao.searchByPage(Templete.class, Cnd.where("type", "=", t).desc("createDate"), currentPage, SystemContext.PAGE_SIZE);
			count = basicDao.searchCount(Templete.class, Cnd.where("type", "=", t));
		}else{
			result = basicDao.searchByPage(Templete.class, currentPage,  SystemContext.PAGE_SIZE, "createDate");
...
//		TempleteDao dao = new TempleteDao(ioc);
		...
		if (maxPage > 1) {
			List<Templete> ts = basicDao.searchByPage(Templete.class, (currentPage + 1),SystemContext.PAGE_SIZE, "id");
			for (Templete t : ts) {
...
//		TempleteDao dao = new TempleteDao(ioc);
	...
	@Ok("Json")
	public String searchByType(@Param("type") int type,Ioc ioc){
...
//		TempleteDao dao = new TempleteDao(ioc);
		...
		switch(type){
		case 0: t = TemplateType.ABOUT;
			break;
		case 1: t = TemplateType.CACAT;
			break;
		case 2: t = TemplateType.DETAIL;
			break;
		case 3: t = TemplateType.LIST;
			break;
		case 4: t = TemplateType.MESSAGE;
			break;
		case 5: t = TemplateType.DOWNLOAD;
			break;
		case 6: t = TemplateType.GROUP; 
			break;
		default:
				break;
		}
